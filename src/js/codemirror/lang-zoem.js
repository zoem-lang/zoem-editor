...
/// A language provider based on the Zoem parser,
/// extended with highlighting and indentation information.
const zoemLanguage = LRLanguage.define({
...
/// Zoem language support.
function zoem() {
    return new LanguageSupport(zoemLanguage);
}

export { zoem, zoemLanguage };